...
NAMES_BY_ISO2, NAME_ALIASES and DEMONYMS below are generated from the
mledoze/countries dataset (https://github.com/mledoze/countries, ODbL
licensed) — common name, official name, alternate spellings and English
demonyms for all 250 ISO-3166 entries. Regenerate by re-running the
generation steps in this file's git history if the upstream dataset changes.
"""
